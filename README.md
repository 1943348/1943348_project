...
Clone the repository to your local machine using git clone (https://github.com/sriyaroy/1943348_project)
Open the project in Android Studio
Build and run the app on your emulator or device - Please run on a Pixel 2
